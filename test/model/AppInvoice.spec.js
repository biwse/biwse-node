...
(function(root, factory) {
  ...
  describe('AppInvoice', function() {
    it('should create an instance of AppInvoice', function() {
      // uncomment below and update the code to test AppInvoice
      //var instane = new biwse.AppInvoice();
      //expect(instance).to.be.a(biwse.AppInvoice);
    });
